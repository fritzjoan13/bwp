    ...
    <div class="flex">
            ...
            @foreach(session()->get('cart', []) as $row)
                ...
                <div class="w-[95%] rounded-none shadow-xl mt-2">
                    <div class="ml-5 mt-5 flex">
                        ...
                        <img src= '{{ url('produk/'.$row->foto_barang) }}' class="w-44 ml-3 my-5" alt="">
                            ...
                            <div class="custom-number-input h-10 w-32 ml-5">
                                <div class="flex flex-row h-10 w-full rounded-lg relative bg-transparent mt-1">
                                    ...
                                    <input type="number" id="val2"
                                        ...
                                        name="custom-input-number" max="49" value="{{ $row->qty }}"></input>
        ...
        <div class="w-[35%] flex flex-col items-center">
            <div class=" w-[95%] rounded-none w-80 bg-base-100 shadow-xl mt-10">
                ...
                @if ($count > 0)
                    <a href="{{route('checkout')}}" class="btn bg-blue-950 btn-primary text-white w-full mx-3 my-3" id="but">Check Out</a>
                @else
                    <a href="{{route('checkout')}}" class="btn bg-blue-950 btn-primary text-white w-full mx-3 my-3" id="but" disabled>Check Out</a>
                @endif
            </div>
        </div>
    </div>
